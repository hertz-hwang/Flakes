# Generated by Powerlevel10k configuration wizard on 2022-11-24 at 20:23 CST.
	...
	() {
	  ...
	  #################################[ os_icon: os identifier ]##################################
	  # OS identifier color.
	  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=002
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='❮'
	  ...
	  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
	  # Timewarrior color.
	  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=002
	  typeset -g POWERLEVEL9K_TIMEWARRIOR_BACKGROUND=000
